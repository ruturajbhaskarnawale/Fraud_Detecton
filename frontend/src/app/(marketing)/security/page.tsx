  ...
  return (
    <div className="min-h-screen bg-background text-foreground pt-32 pb-20 px-6">
      <div className="max-w-5xl mx-auto space-y-20">
        ...
        <div className="p-12 bg-secondary border border-border rounded-[3rem] space-y-8">
...
function SecurityCard({ title, desc, icon }: any) {
  return (
    <div className="p-10 bg-card border border-border rounded-[2.5rem] space-y-6 hover:border-blue-500/50 transition-all group shadow-sm">
